...
export const metadata: Metadata = {
  ...
  description:
    'Senior Manager of Product Design at ServiceNow. Nearly 20 years turning ambiguity into shipped experiences, leading designers across business units and time zones.',
}
